...
public class CmdRegist extends AbstractBusiness
{
	...
	public String business(ChannelHandlerContext ctx, Object msg)
	{
		...
		String fileList[] = ServerConfigBank.GetConfigList("192.168.80.132", serviceName);
		for(String file : fileList)
		{
			String content = ServerConfigBank.GetConfigContent("192.168.80.132", serviceName, file);
